...
@Component({
  ...
  standalone: true,
  imports: [FooterComponent, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonTabs, IonTabBar, IonTabButton, RouterLink, IonIcon, IonInfiniteScroll, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonInput, IonLabel, IonDatetime, IonDatetimeButton, IonModal, IonSelect, IonSelectOption]
})
